...
def send_text(text, coversation_id, base_url, session_token) -> int:
    ...
    headers = {
        ...
        "Cookie": "MoodleSession=lv8v0csefl3m6nmaqbdpb68fop; MOODLEID1_=%253A%2580%2529%25F4%25F7%2590x%25BD%259F",
        "Origin": "https://moodle.jobelmannschule.de",
        "Referer": "https://moodle.jobelmannschule.de/my/",
